...
import IAddresses from "@/app/interfaces/IAddresses";
...
const ImmobileForm: React.FC<ImmobileFormProps> = ({ address }) => {
    const [type, setType] = useState(address?.type || '');
    const [situation, setSituation] = useState(address?.situation || '');
    const [realRight, setRealRight] = useState(address?.realRight || '');
    const [debt, setDebt] = useState(address?.debt || '');
    ...
    return (
        <form className="flex flex-col w-2/3 mx-auto gap-7">
            <div className="grid md:grid-cols-2 md:gap-6">
                <div className="relative z-0 w-full">
                    <input
                        ...
                        type="text" name="city" id="city" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div className="relative z-0 w-full">
                    <input
                        ...
                        type="text" name="zipcode" id="zipcode" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
            ...
            <div className="grid md:grid-cols-4 md:gap-6">
                <div className="relative z-0 w-full col-span-2">
                    <input
                        ...
                        type="text" name="street" id="street" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div className="relative z-0 w-full">
                    <input
                        ...
                        type="text" name="neighborhood" id="neighborhood" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div className="relative z-0 w-full">
                    <input
                        ...
                        type="number" name="number" id="number" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
            ...
            <div className="relative z-0 w-full">
                <input
                    defaultValue={address?.owner}
                    type="text" name="owner" id="owner" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                <label htmlFor="owner" className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Proprietário</label>
            </div>
            <div className="grid md:grid-cols-4 md:gap-6">
                <div className="relative z-0 w-full col-span-2">
                    <input
                        defaultValue={address?.venalValue}
                        type="text" name="venalValue" id="venalValue" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                    <label htmlFor="venalValue" className="peer-focus:font-medium absolute text-sm text-gray-500 focus:text-blue-800 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Valor Venal</label>
                </div>
                <div className="relative z-0 w-full">
                    <select
                        name="type"
            ...
            {type === 'urban' && (
                <div className="relative z-0 w-full">
                    <input
                        defaultValue={address?.iptu}
                        type="number" name="iptu" id="iptu" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
